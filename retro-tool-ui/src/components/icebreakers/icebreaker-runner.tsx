 ...
 * drops the page chrome so it can sit inside a modal (e.g. the standup room).
 */
type RunnerVariant = 'page' | 'embedded'

interface IcebreakerRunnerProps {
  sessionId: string
...
function PhaseContent({
  ...
  switch (session.status) {
    ...
    case ICEBREAKER_SESSION_STATUSES.Completed:
      return <CompletedRecap session={session} kept={kept} onExit={onExit} />
